<template>
    <div class="flex flex-col gap-3">
        <span>Change worklog</span>
        <div class="line"></div>
        <form class="box-col-md" @submit.prevent="changeWorklog">
            <CustomInput
                v-model="month"
                @blur="validateMonth"
                label="Month: "
...
import useChangeWorklogForm from '~/composables/Task9/useChangeWorklogForm';
